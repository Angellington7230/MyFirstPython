...
Legibilidade conta.
Casos especiais não são especiais o bastane para quebrar as regras.
...
Se a implementação é fácil de explicar, poder ser uma boa ideia.
